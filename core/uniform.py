...
class Uniform(object):
    ...
    def locateVariable(self, programRef, variableName):
        # Di mana lokasi memori variabel uniform bernama `variableName` di shader
        self.variableRef = glGetUniformLocation(programRef, variableName)
    def uploadData(self):
        # Mengirim data dari Python ke lokasi memori tersebut.
        ...
        elif self.dataType == "mat4": # tambahan, setelah proses membuat geometry
